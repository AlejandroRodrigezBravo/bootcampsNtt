...
@Log4j2
public class NttSpringDataBravo implements CommandLineRunner {

	@Autowired
	private IClienteService servicioCliente;

	public static void main(String[] args) {
		SpringApplication.run(NttSpringDataBravo.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		for(Cliente c : listaClientes) {
			System.out.println(servicioCliente.buscarNombreCompleto(c.getName(), c.getLastName()));
